...
$(document).ready(function() {
  $('#modal-demo-01').on('show.nth.modal', function() {
    console.log(
      'Модальное окно #modal-demo-01: сработало событие show.nth.modal'
    ); // eslint-disable-line no-console
  });
  $('#modal-demo-01').on('shown.nth.modal', function() {
    console.log(
      'Модальное окно #modal-demo-01: сработало событие shown.nth.modal'
    ); // eslint-disable-line no-console
  });
  $('#modal-demo-01').on('hide.nth.modal', function() {
    console.log(
      'Модальное окно #modal-demo-01: сработало событие hide.nth.modal'
    ); // eslint-disable-line no-console
  });
  $('#modal-demo-01').on('hidden.nth.modal', function() {
    console.log(
      'Модальное окно #modal-demo-01: сработало событие hidden.nth.modal'
    ); // eslint-disable-line no-console
  });
});
...
+(function($) {
  ...
  $(document).on('click.nth.modal.data-api', '[data-toggle="modal"]', function(
    e
  ) {
    var $this = $(this);
    ...
    var option = $target.data('nth.modal')
      ? 'toggle'
      : $.extend(
